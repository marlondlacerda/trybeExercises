...
// emailListInData.forEach(showEmailList); GABRITO
// emailListInData.forEach((email) => console.log(`O email ${email} esta cadastrado em nosso banco de dados!`)); <= REFATORADO
...
const hasName = (arr, name) => {
  //Adicione seu código aqui
  return arr.some((curr) => curr === name)
...
const verifyAges = (arr, minimumAge) => {
  //Adicione seu código aqui
  return arr.every((curr) => curr.age >= minimumAge)
}
