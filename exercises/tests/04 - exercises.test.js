const service = require('../exercises/04 - exercises');
...
// O segundo deve interpretar que a requisição falhou e ter como valor "request failed". Crie todos os testes que achar necessário.
