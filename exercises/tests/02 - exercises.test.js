const service = require('../exercises/02 - exercises');
...
// 2 - Com a mesma função do exercício anterior, utilizando o mock, crie uma nova implementação que deve receber dois parâmetros e
// retornar a divisão do primeiro pelo segundo. Essa implementação deve ocorrer uma única vez. Faça os testes necessários.
describe('Testes da Solução 2', () => {
...
// 3 - Ainda com a mesma função do primeiro exercício, utilizando o mock, crie uma nova implementação que receba três parâmetros 
// e retorne sua multiplicação. Após fazer os devidos testes para ela, resete sua implementação e crie uma nova que receba um parâmetro 
// e retorne seu dobro. Faça os testes necessários.
describe('Testes da Solução 3', () => {
